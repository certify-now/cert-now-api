...
public class EpcAssessment {
  ...
  @Column private Integer boilerAgeYears;

  @Column(nullable = false)
  private Integer currentScore;

  @Column private Integer environmentalImpact;

  @Column private Boolean hasInsulatedTank;
  ...
  @Column private Integer lowEnergyLightingPct;

  @Column private Integer numberOfFloors;

  @Column private Integer potentialScore;
  ...
  @Column private OffsetDateTime lodgedAt;
  ...
  @Column private String potentialRating;
