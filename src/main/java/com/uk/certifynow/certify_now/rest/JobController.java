...
import com.uk.certifynow.certify_now.service.JobService;
...
public class JobController {
    ...
    public ApiResponse<Page<JobSummaryResponse>> listJobs(
        ...
        final Pageable pageable = PageRequest.of(page, cappedSize,
                Sort.by(Sort.Direction.DESC, "createdAt"));
        final Page<JobSummaryResponse> jobs = jobService.listJobs(actorId, actorRole, status, certificateType,
                pageable);
    ...
    public ApiResponse<JobResponse> declineJob(
        ...
        return ApiResponse.of(jobService.declineJob(id, engineerId, safeRequest),
    ...
    public ApiResponse<JobResponse> cancelJob(
        ...
        final UUID actorId = extractUserId(authentication);
        final UserRole actorRole = extractRole(authentication);
        return ApiResponse.of(jobService.cancelJob(id, actorId, actorRole, request),
                requestId(httpRequest));
    }
