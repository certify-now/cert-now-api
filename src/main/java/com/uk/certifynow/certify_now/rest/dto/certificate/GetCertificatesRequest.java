 ...
 * @param includeHistory when true, SUPERSEDED certificates are included so the customer can see
 *     their full compliance history; defaults to false
 */
public record GetCertificatesRequest(
    String type, String status, UUID propertyId, String sort, boolean includeHistory) {}
