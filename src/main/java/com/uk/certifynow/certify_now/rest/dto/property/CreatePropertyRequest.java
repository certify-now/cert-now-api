...
public record CreatePropertyRequest(
    ...
    @Size(max = 12)
        @Schema(
            description =
                "Unique Property Reference Number — populated automatically via address autocomplete",
            example = "100023336956")
        String uprn,
    @Schema(description = "WGS84 latitude from address autocomplete resolve", example = "51.5034")
        Double latitude,
    @Schema(description = "WGS84 longitude from address autocomplete resolve", example = "-0.1276")
        Double longitude) {}
