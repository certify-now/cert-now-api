...
@Schema(description = "Request body for registering a new property")
public record CreatePropertyRequest(

    @NotNull @Size(max = 255) @Schema(description = "First line of the property address", example = "14 Oak Lane")
    String addressLine1,

    @Size(max = 255) @Schema(description = "Second line of the property address (optional)", example = "Flat 2")
    String addressLine2,

    @NotNull @Size(max = 100) @Schema(description = "City", example = "London")
    String city,
    ...
    @NotNull @Schema(description = "Property type")
    ...
    @Min(0) @Schema(description = "Number of bedrooms")
    Integer bedrooms,

    @Min(1) @Schema(description = "Number of floors")
    Integer floors,

    @Digits(integer = 8, fraction = 2) @Schema(description = "Floor area in square metres", example = "75.50")
    ...
    @Size(max = 12) @Schema(description = "Unique Property Reference Number — populated automatically via address autocomplete", example = "100023336956")
    String uprn
) {}
