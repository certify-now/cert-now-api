 ...
 *
 * <p>These values are returned in {@code PropertyDTO} fields such as {@code gasStatus}, {@code
 * eicrStatus}, and {@code epcStatus}, and drive the colour-coding and action prompts in the
 * frontend.
 *
 * <ul>
