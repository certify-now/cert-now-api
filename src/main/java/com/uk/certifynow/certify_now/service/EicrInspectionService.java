...
public class EicrInspectionService {
    ...
    public EicrInspectionService(final EicrInspectionRepository eicrInspectionRepository,
    ...
    public EicrInspectionDTO get(final UUID id) {
        return eicrInspectionRepository.findById(id)
                .map(eicrInspection -> mapToDTO(eicrInspection, new EicrInspectionDTO()))
    ...
    public void update(final UUID id, final EicrInspectionDTO eicrInspectionDTO) {
        final EicrInspection eicrInspection = eicrInspectionRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(eicrInspectionDTO, eicrInspection);
    ...
    private EicrInspectionDTO mapToDTO(final EicrInspection eicrInspection,
            final EicrInspectionDTO eicrInspectionDTO) {
        ...
        eicrInspectionDTO.setJob(eicrInspection.getJob() == null ? null : eicrInspection.getJob().getId());
        return eicrInspectionDTO;
    }

    private EicrInspection mapToEntity(final EicrInspectionDTO eicrInspectionDTO,
        ...
        final Job job = eicrInspectionDTO.getJob() == null ? null : jobRepository.findById(eicrInspectionDTO.getJob())
    ...
    public void on(final BeforeDeleteJob event) {
        ...
        final EicrInspection jobEicrInspection = eicrInspectionRepository.findFirstByJobId(event.getId());
