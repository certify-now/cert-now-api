...
public class EngineerInsuranceService {
    ...
    public EngineerInsuranceService(final EngineerInsuranceRepository engineerInsuranceRepository,
    ...
    public List<EngineerInsuranceDTO> findAll() {
        final List<EngineerInsurance> engineerInsurances = engineerInsuranceRepository.findAll(Sort.by("id"));
    ...
    public EngineerInsuranceDTO get(final UUID id) {
        return engineerInsuranceRepository.findById(id)
                .map(engineerInsurance -> mapToDTO(engineerInsurance, new EngineerInsuranceDTO()))
    ...
    public void update(final UUID id, final EngineerInsuranceDTO engineerInsuranceDTO) {
        final EngineerInsurance engineerInsurance = engineerInsuranceRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(engineerInsuranceDTO, engineerInsurance);
    ...
    private EngineerInsuranceDTO mapToDTO(final EngineerInsurance engineerInsurance,
            final EngineerInsuranceDTO engineerInsuranceDTO) {
        ...
        engineerInsuranceDTO.setEngineerProfile(engineerInsurance.getEngineerProfile() == null ? null : engineerInsurance.getEngineerProfile().getId());
        return engineerInsuranceDTO;
    }

    private EngineerInsurance mapToEntity(final EngineerInsuranceDTO engineerInsuranceDTO,
        ...
        final EngineerProfile engineerProfile = engineerInsuranceDTO.getEngineerProfile() == null ? null : engineerProfileRepository.findById(engineerInsuranceDTO.getEngineerProfile())
    ...
    public void on(final BeforeDeleteEngineerProfile event) {
        ...
        final EngineerInsurance engineerProfileEngineerInsurance = engineerInsuranceRepository.findFirstByEngineerProfileId(event.getId());
