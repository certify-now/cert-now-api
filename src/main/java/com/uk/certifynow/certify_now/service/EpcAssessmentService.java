...
public class EpcAssessmentService {
    ...
    public EpcAssessmentDTO get(final UUID id) {
        return epcAssessmentRepository.findById(id)
                .map(epcAssessment -> mapToDTO(epcAssessment, new EpcAssessmentDTO()))
    ...
    public void update(final UUID id, final EpcAssessmentDTO epcAssessmentDTO) {
        final EpcAssessment epcAssessment = epcAssessmentRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(epcAssessmentDTO, epcAssessment);
    ...
    private EpcAssessmentDTO mapToDTO(final EpcAssessment epcAssessment,
            final EpcAssessmentDTO epcAssessmentDTO) {
    ...
    private EpcAssessment mapToEntity(final EpcAssessmentDTO epcAssessmentDTO,
        ...
        final Job job = epcAssessmentDTO.getJob() == null ? null : jobRepository.findById(epcAssessmentDTO.getJob())
