...
public class JobService {
    ...
    private Job mapToEntity(final JobDTO jobDTO, final Job job) {
        ...
        final User customer = jobDTO.getCustomer() == null ? null : userRepository.findById(jobDTO.getCustomer())
                .orElseThrow(() -> new NotFoundException("customer not found"));
        job.setCustomer(customer);
        final User engineer = jobDTO.getEngineer() == null ? null : userRepository.findById(jobDTO.getEngineer())
                .orElseThrow(() -> new NotFoundException("engineer not found"));
        job.setEngineer(engineer);
        final Property property = jobDTO.getProperty() == null ? null : propertyRepository.findById(jobDTO.getProperty())
