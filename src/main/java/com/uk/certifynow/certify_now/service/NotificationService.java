...
public class NotificationService {
    ...
    private NotificationDTO mapToDTO(final Notification notification,
        ...
        notificationDTO.setRelatedJob(notification.getRelatedJob() == null ? null : notification.getRelatedJob().getId());
    ...
    private Notification mapToEntity(final NotificationDTO notificationDTO,
        ...
        final Job relatedJob = notificationDTO.getRelatedJob() == null ? null : jobRepository.findById(notificationDTO.getRelatedJob())
    ...
    public void on(final BeforeDeleteJob event) {
        ...
        final Notification relatedJobNotification = notificationRepository.findFirstByRelatedJobId(event.getId());
