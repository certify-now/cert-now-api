...
public class PaymentService {
    ...
    private Payment mapToEntity(final PaymentDTO paymentDTO, final Payment payment) {
        ...
        final User customer = paymentDTO.getCustomer() == null ? null : userRepository.findById(paymentDTO.getCustomer())
                .orElseThrow(() -> new NotFoundException("customer not found"));
        payment.setCustomer(customer);
        final Job job = paymentDTO.getJob() == null ? null : jobRepository.findById(paymentDTO.getJob())
