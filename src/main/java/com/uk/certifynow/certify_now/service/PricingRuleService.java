...
public class PricingRuleService {
    ...
    public PricingRuleService(final PricingRuleRepository pricingRuleRepository,
    ...
    public void update(final UUID id, final PricingRuleDTO pricingRuleDTO) {
        final PricingRule pricingRule = pricingRuleRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(pricingRuleDTO, pricingRule);
    ...
    private PricingRuleDTO mapToDTO(final PricingRule pricingRule,
            final PricingRuleDTO pricingRuleDTO) {
    ...
    private PricingRule mapToEntity(final PricingRuleDTO pricingRuleDTO,
