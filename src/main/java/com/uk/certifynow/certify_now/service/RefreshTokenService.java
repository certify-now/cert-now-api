...
public class RefreshTokenService {
    ...
    public void update(final UUID id, final RefreshTokenDTO refreshTokenDTO) {
        final RefreshToken refreshToken = refreshTokenRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(refreshTokenDTO, refreshToken);
    ...
    private RefreshTokenDTO mapToDTO(final RefreshToken refreshToken,
    ...
    private RefreshToken mapToEntity(final RefreshTokenDTO refreshTokenDTO,
        ...
        final User user = refreshTokenDTO.getUser() == null ? null : userRepository.findById(refreshTokenDTO.getUser())
