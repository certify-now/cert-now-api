...
public class StripeWebhookEventService {
    ...
    public List<StripeWebhookEventDTO> findAll() {
        final List<StripeWebhookEvent> stripeWebhookEvents = stripeWebhookEventRepository.findAll(Sort.by("id"));
    ...
    public StripeWebhookEventDTO get(final UUID id) {
        return stripeWebhookEventRepository.findById(id)
                .map(stripeWebhookEvent -> mapToDTO(stripeWebhookEvent, new StripeWebhookEventDTO()))
    ...
    public void update(final UUID id, final StripeWebhookEventDTO stripeWebhookEventDTO) {
        final StripeWebhookEvent stripeWebhookEvent = stripeWebhookEventRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(stripeWebhookEventDTO, stripeWebhookEvent);
    ...
    private StripeWebhookEventDTO mapToDTO(final StripeWebhookEvent stripeWebhookEvent,
    ...
    private StripeWebhookEvent mapToEntity(final StripeWebhookEventDTO stripeWebhookEventDTO,
