...
public class UrgencyMultiplierService {
    ...
    public List<UrgencyMultiplierDTO> findAll() {
        final List<UrgencyMultiplier> urgencyMultipliers = urgencyMultiplierRepository.findAll(Sort.by("id"));
    ...
    public UrgencyMultiplierDTO get(final UUID id) {
        return urgencyMultiplierRepository.findById(id)
                .map(urgencyMultiplier -> mapToDTO(urgencyMultiplier, new UrgencyMultiplierDTO()))
    ...
    public void update(final UUID id, final UrgencyMultiplierDTO urgencyMultiplierDTO) {
        final UrgencyMultiplier urgencyMultiplier = urgencyMultiplierRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        mapToEntity(urgencyMultiplierDTO, urgencyMultiplier);
    ...
    private UrgencyMultiplierDTO mapToDTO(final UrgencyMultiplier urgencyMultiplier,
            final UrgencyMultiplierDTO urgencyMultiplierDTO) {
    ...
    private UrgencyMultiplier mapToEntity(final UrgencyMultiplierDTO urgencyMultiplierDTO,
