 ...
 * <p>
 * Handles:
 * - Generating and sending verification tokens
 ...
 * - SHA-256 hashing (tokens never stored in plaintext)
...
public class EmailVerificationService {
     ...
     *
     * <p>
     * Called automatically after registration or when user requests a new
     * verification email.
     *
     ...
     *
     * <p>
     * Validates token, marks it as used, and updates user's email_verified status.
     * If user was
    ...
    public void verifyEmail(final String rawToken) {
        ...
        if (token.isExpired(clock)) {
            throw new BusinessException(
                    HttpStatus.BAD_REQUEST, "INVALID_TOKEN", "Token has expired");
        }
