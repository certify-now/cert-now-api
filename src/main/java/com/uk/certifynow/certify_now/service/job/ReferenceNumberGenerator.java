 ...
 *
 * <p>
 * Example: CN-20260214-A3K8
 *
 * <p>
 * XXXX is a random 4-character uppercase alphanumeric. If a collision occurs
 * (unique constraint
 * violation), the caller should retry — this generator always returns a fresh
 * value.
 */
@Component
