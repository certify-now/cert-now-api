...
import com.uk.certifynow.certify_now.service.auth.CustomerProfileView;
...
public class AuthMapper {
   ...
   * "Check your email" message in all cases.
   */
  public AuthResponse toGenericRegistrationResponse() {
    return new AuthResponse(null, null, null, 0L, null);
  }
