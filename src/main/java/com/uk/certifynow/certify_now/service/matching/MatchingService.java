...
public class MatchingService {
  ...
  public List<EngineerProfile> findCandidates(final Job job) {
    ...
    // TODO: Qualification filtering — once cert-type-to-qualification mapping is defined,
    // filter engineers who hold the required qualification for job.getCertificateType().
