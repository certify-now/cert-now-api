...
class JobStatusTest {
  ...
  @CsvSource({
    "CREATED,    MATCHED",
    "CREATED,    AWAITING_ACCEPTANCE",
    "CREATED,    CANCELLED",
    "CREATED,    ESCALATED",
    "AWAITING_ACCEPTANCE, MATCHED",
    "AWAITING_ACCEPTANCE, ESCALATED",
